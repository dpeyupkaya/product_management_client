...
function AuthPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = isLogin ? "https://localhost:7172/api/auth/login" : "https://localhost:7172/api/auth/register";
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6 relative overflow-hidden">
                <div className="relative h-72">
                    <div className={`absolute inset-0 transition-all duration-500 ease-in-out transform ${isLogin ? "opacity-100 z-10" : "opacity-0 z-0"}`}>
                        {/* Login Form */}
